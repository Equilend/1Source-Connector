 ...
 */
@UtilityClass
public class EntityApiTestFactory {
    ...
    public DeclineInstructionEntity buildDeclineInstructionEntity(String id) {
        return DeclineInstructionEntity.builder()
            .declineInstructionId(id)
            .relatedExceptionEventId("relatedEvent")
            .relatedProposalId("relatedProposalId")
            .relatedProposalType(RelatedProposalType.CONTRACT)
            .creationDateTime(LocalDateTime.now())
            .userId("userId")
            .declineReasonCode("DECLINED")
            .declineReasonText("decline reason text")
            .build();
    }

    public static ContractEntity buildContract() {
        return buildContract("32b71278-9ad2-445a-bfb0-b5ada72f7194");
    }
    ...
    public static Position buildPosition(PositionStatus positionStatus) {
        if (positionStatus == null) {
            positionStatus = new PositionStatus(22, OPEN.getValue());
        }
        return Position.builder()
            ...
            .positionAccount(new Account(11L, 1L, "testLei", "testLeiName", "123L", 123L))
            .positionCpAccount(new Account(22L, 2L, "testCpLei", "testCpLeiName", "456L", 456L))
