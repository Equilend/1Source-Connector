...
public enum IntegrationSubProcess {
    ...
    ACKNOWLEDGE_RETURN_NEGATIVELY,
    APPROVE_LOAN_CONTRACT_PROPOSAL,
    CANCEL_LOAN_CONTRACT_PROPOSAL,
    CAPTURE_POSITION_CANCELED,
    CAPTURE_POSITION_SETTLEMENT,
    CAPTURE_RETURN_ACKNOWLEDGEMENT,
    CAPTURE_RETURN_TRADE_CANCELLATION,
    CAPTURE_RETURN_TRADE_SETTLED,
    CONFIRM_RETURN_TRADE,
    CONFIRM_POSITION,
    ...
    GET_RECALL_DETAILS,
    GET_RETURN_ACKNOWLEDGEMENT_DETAILS,
    ...
    PROCESS_1SOURCE_RECALL_CANCELLATION,
    PROCESS_1SOURCE_RECALL_CLOSURE,
    PROCESS_OFF_SETTING_TRADE_CANCEL,
    PROCESS_TRADE_OFF_SET_CANCEL,
    ...
    PROCESS_RETURN_SETTLED,
    PROCESS_RETURN_CANCELED,
    PROCESS_RETURN_TRADE_CANCELED,
    PROCESS_RETURN_TRADE_SETTLED,
