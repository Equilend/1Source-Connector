...
public class RerateDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(rerateId, contractId, rerateStatus, processingStatus, matchingSpireTradeId, relatedSpirePositionId, createDatetime, lastUpdateDatetime, effectiveDate);
  }
