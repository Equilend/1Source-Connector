...
public class RecallDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(qualifiedName, accountAllocationDTOs, accountDTO, accountId, caller, comments, counterpartyId, createTs, createUserId, depoId, isCaller, lastModTs, lastModUserId, lendingAgentId, positionId, rateChange, rateChangeIndexId, rateChangeRate, rateChangeSpread, recallId, recallPositionDTO, recallPositionDTOs, recallReasonId, recallStatus, recallStatusId, recalled, restrictInventory, saleQuantity, securityDetailDTO, securityId, settleDate, statusDTO, subAccountId, systemRefId, tradeDate);
  }
