...
public class FloatingRateDefDTO {
  @JsonProperty("benchmark")
  private BenchmarkCdDTO benchmark = null;
  ...
  public FloatingRateDefDTO benchmark(BenchmarkCdDTO benchmark) {
  ...
  **/
  @Schema(description = "")
  public BenchmarkCdDTO getBenchmark() {
    return benchmark;
  }

  public void setBenchmark(BenchmarkCdDTO benchmark) {
    this.benchmark = benchmark;
  }

  public FloatingRateDefDTO baseRate(Double baseRate) {
  ...
  **/
  ...
  public FloatingRateDefDTO spread(Double spread) {
    this.spread = spread;
    return this;
  }
  ...
  **/
  ...
  public FloatingRateDefDTO effectiveRate(Double effectiveRate) {
  ...
  **/
  ...
  public FloatingRateDefDTO isAutoRerate(Boolean isAutoRerate) {
  ...
  **/
  ...
  public FloatingRateDefDTO cutoffTime(String cutoffTime) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FloatingRateDefDTO floatingRateDef = (FloatingRateDefDTO) o;
  ...
  public String toString() {
    ...
    sb.append("class FloatingRateDefDTO {\n");
