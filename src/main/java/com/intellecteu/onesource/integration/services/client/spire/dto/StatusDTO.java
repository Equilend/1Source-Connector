...
public class StatusDTO {
    ...
    public StatusDTO qualifiedName(String qualifiedName) {
    ...
    /**
     * Allowed values for position and trade status: OPEN, CLOSED, FUTURE, PREPAID, FAILED, CANCELLED. Allowed values
     * for trade settled status: NEW, READY, PENDING, SETTLED, DELETED, FAILED, NO INSTRUCTION, PRINTED, ACCEPTED, VOID
     *
     * @return status
     **/
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.qualifiedName, statusDTO.qualifiedName) &&
            Objects.equals(this.forAccount, statusDTO.forAccount) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(qualifiedName, forAccount, forAld, forFeeds, forInstruction, forLocates, forOrder,
            forPosition, forRecall, forSecurity, forSettlement, forTrade, status, statusId);
    }
