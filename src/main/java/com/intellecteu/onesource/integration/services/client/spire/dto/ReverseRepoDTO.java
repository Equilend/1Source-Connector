...
public class ReverseRepoDTO {
    ...
    public int hashCode() {
        return Objects.hash(qualifiedName, accountAllocations, accountGroup, accountGroupAccountNo2, accountGroupId,
            accountId, accountName, accountNo, accountNo2, accrualDate, allInRate, amount, basis, basisName, calendar,
            calendarId, collateralAccountId, collateralAccountName, collateralAccountNo, collateralAccountNo2,
            collateralBasis, collateralBasisName, collateralCalendar, collateralCalendarName, collateralCustodianBank,
