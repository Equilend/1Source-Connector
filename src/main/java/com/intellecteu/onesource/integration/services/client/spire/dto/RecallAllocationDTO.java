...
public class RecallAllocationDTO {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(qualifiedName, positionId, recallAllocationAccountName, recallAllocationAccountNo,
            recallAllocationAccountNo2, recallAllocationPositionDTO, recallId, recalled);
    }
    ...
    public String toString() {
        ...
        sb.append("    recallAllocationAccountName: ").append(toIndentedString(recallAllocationAccountName))
            .append("\n");
        ...
        sb.append("    recallAllocationPositionDTO: ").append(toIndentedString(recallAllocationPositionDTO))
            .append("\n");
