...
public class TradeEvent {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(qualifiedName, accountId, allowNegativeInventory, changeQuantity, counterpartyId,
            cptySubTypeId, depoId, doNotRecall, forceValidity, oldSettleStatusId, positionTypeId, postOrSettle,
            quantity, securityId, settleDate, settleStatusId, statusId, tradeDate, tradeId, tradeTypeId);
    }
