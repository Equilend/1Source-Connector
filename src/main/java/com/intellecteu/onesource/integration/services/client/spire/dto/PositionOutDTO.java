...
public class PositionOutDTO {
  ...
  private Double suggestedQuantity = null;
  ...
  **/
  ...
  public PositionOutDTO counterpartyGroupAccountNo2(String counterpartyGroupAccountNo2) {
  ...
  **/
  ...
  public PositionOutDTO dtcNo(Long dtcNo) {
    this.dtcNo = dtcNo;
    return this;
  }
  ...
  **/
  @ApiModelProperty(value = "")
  public Long getDtcNo() {
    return dtcNo;
  }

  public void setDtcNo(Long dtcNo) {
    this.dtcNo = dtcNo;
  }
  ...
  **/
  ...
  public PositionOutDTO groupedPositionRef(String groupedPositionRef) {
  ...
  **/
  ...
  public PositionOutDTO isExplodedPosition(Boolean isExplodedPosition) {
  ...
  **/
  ...
  public PositionOutDTO ledgerId(String ledgerId) {
  ...
  **/
  ...
  public PositionOutDTO matchGroupId(Long matchGroupId) {
  ...
  **/
  ...
  public PositionOutDTO suggestedQuantity(Double suggestedQuantity) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.account2DTO, positionOutDTO.account2DTO) &&
        ...
        Objects.equals(this.counterpartyGroupAccountNo2, positionOutDTO.counterpartyGroupAccountNo2) &&
        ...
        Objects.equals(this.dtcNo, positionOutDTO.dtcNo) &&
        ...
        Objects.equals(this.groupedPositionRef, positionOutDTO.groupedPositionRef) &&
        ...
        Objects.equals(this.isExplodedPosition, positionOutDTO.isExplodedPosition) &&
        ...
        Objects.equals(this.ledgerId, positionOutDTO.ledgerId) &&
        ...
        Objects.equals(this.matchGroupId, positionOutDTO.matchGroupId) &&
        ...
        Objects.equals(this.suggestedQuantity, positionOutDTO.suggestedQuantity) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(account2DTO, accountDTO, accountGroupDTO, accountId, accountId2, accountId3, accrualBalanceDTO, accruedInt, amount, approveTraderId, basisDTO, basisId, beginFactor, beginPrice, beginQuantity, calendarId, collateralTypeDTO, collateralTypeId, comments, contractValue, counterPartyDTO, counterpartyAccountNo, counterpartyGroupAccountNo, counterpartyGroupAccountNo2, counterpartyGroupName, counterpartyGroupdtcNo, counterpartyId, createTs, createUserId, currencyDTO, currencyId, customValue1, customValue10, customValue2, customValue3, customValue4, customValue5, customValue6, customValue7, customValue8, customValue9, deliverFree, depoId, depositoryDTO, discountMargin, discountRate, dtcNo, encumberedQuantity, endDate, evergreenTerm, excludeFromAutoMark, exposureDTO, exposureId, factor, factoredPrice, fxAmount, fxMarketAmount, groupedPositionRef, haircutPrice, indemnified, indexDTO, indexId, instruction, isExplodedPosition, isPooled, lastModTs, lastModUserId, ledgerId, loanBorrowDTO, lookBack, markStatusId, marketAmount, marketPrice, matchGroupId, matchGroupName, minFeeOrRebate, noDpAccrual, poolPositionId, positionId, positionRef, positionTypeId, positiontypeDTO, prepayBasisId, prepayDate, prepayIndexId, prepayLookBack, prepayRate, prepaySpread, price, principalOrInterest, quantity, rate, recommendTraderId, repriceAtReset, resetDate, secCountryKy, securityDetailDTO, securityId, seqNo, settleDate, settledQuantity, shellCusip, spread, statusDTO, statusId, strategyDTO, strategyId, suggestedQuantity, targetPrice, termId, tradeDate, tradingDeskId, tradingdeskDTO, tripartyCustodianId, userDTO, userName, yield);
  }
  ...
  public String toString() {
    ...
    sb.append("    suggestedQuantity: ").append(toIndentedString(suggestedQuantity)).append("\n");
