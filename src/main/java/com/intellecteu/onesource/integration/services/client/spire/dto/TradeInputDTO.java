...
public class TradeInputDTO {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(qualifiedName, action, allowTradeForNoCurrDaySecPrice, byPassLimits, bypassRTI, cancelFail,
            chainedTradeDTO, doNotRecall, eventList, groupedPositionRef, msgId, orderId, originalTrade,
            positionLimitUsed, postOrSettle, skipInventoryCheckAndUpdate, skipLimitCheckAndUpdate, source, system,
            systemId, trade, tradeRefNo, updateInventory, userId, userName);
    }
