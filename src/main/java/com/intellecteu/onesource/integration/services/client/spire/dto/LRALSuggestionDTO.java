...
public class LRALSuggestionDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(qualifiedName, allocationId, counterpartyId, counterpartyName, currentSourceAllocationQty, currentTargetAllocationQty, cusip, depoId, factor, isin, omniPositionId, omniQuantity, positionType, positionTypeId, price, priceFactor, securityId, sedol, sourceCollateralAccountId, sourceLendingAccountId, sourceLendingAccountShortName, sourcePositionId, suggestedAllocationQty, suggestedAmount, targetCollateralAccountId, targetLendingAccountId, targetLendingAccountShortName, targetPositionId, ticker);
  }
