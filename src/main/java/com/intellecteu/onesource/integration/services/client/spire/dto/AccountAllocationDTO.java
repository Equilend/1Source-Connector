...
public class AccountAllocationDTO {
    ...
    public AccountAllocationDTO qualifiedName(String qualifiedName) {
    ...
    /**
     * Required only when posting a position &amp; Either accountId or accountNumber or accountNo2 or accountName is
     * required
     *
     * @return accountId
     **/
    ...
    /**
     * Required only when posting a position &amp; Required only when posting a position Either accountId or
     * accountNumber or accountNo2 or accountName is required
     *
     * @return accountName
     **/
    ...
    /**
     * Required only when posting a position &amp; Either receiverAccountId or receiverAccountNumber or
     * receiverAccountNo2 or receiverAccountName or useDefaultReceiverAccount is required
     *
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.qualifiedName, accountAllocationDTO.qualifiedName) &&
            Objects.equals(this.accountDTO, accountAllocationDTO.accountDTO) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(qualifiedName, accountDTO, accountId, accountLegalName, accountName, accountNo2,
            accountNumber, allocated, allocationId, amount, available, bias, comments, currentAvailable, customValue1,
            customValue3, hasExistingPosition, inventory, lendablePct, limit, maxSettleDate, onLoan, pendingQty,
            positionId, positionRef, previousAllocation, recalled, receiverAccountId, receiverAccountName,
            receiverAccountNo2, receiverAccountNumber, restricted, restrictionId, sameDayQty, sequenceNumber, status,
            suggestedAllocation, useDefaultReceiverAccount);
    }
