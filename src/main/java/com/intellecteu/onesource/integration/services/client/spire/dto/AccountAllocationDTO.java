...
public class AccountAllocationDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(qualifiedName, accountDTO, accountId, accountLegalName, accountName, accountNo2, accountNumber, allocated, allocationId, amount, available, bias, comments, currentAvailable, customValue1, customValue3, hasExistingPosition, inventory, lendablePct, limit, maxSettleDate, onLoan, pendingQty, positionId, positionRef, previousAllocation, recalled, receiverAccountId, receiverAccountName, receiverAccountNo2, receiverAccountNumber, restricted, restrictionId, sameDayQty, sequenceNumber, status, suggestedAllocation, useDefaultReceiverAccount);
  }
