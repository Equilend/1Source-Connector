...
public class DepositoryDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(qualifiedName, bulkable, countryId, depoGroup, depoId, depoKy, forAutomark, forPrepayDate, maxQuantity, offset, partyBicBranchRequired, securityRefId, stcoValue, swiftBicId, swiftCode, tzname, useSwiftCodeOnly);
  }
