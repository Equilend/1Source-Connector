...
public class IndexDTO {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(qualifiedName, bmAccountId, calendarDTO, calendarId, counterPartyDTO,
            counterpartyGroupAccountNo, counterpartyGroupName, counterpartyGroupdtcNo, counterpartyId,
            counterpartydtcNo, eqlBenchmark, extIndexRef, indexCategory, indexId, indexName, isActive, lookBack,
            parentIndexId, parentIndexName, securityDetailDTO, securityId, sftrPmtFreqMulti, sftrPmtFreqTime,
            sftrRateName, sftrRefPerMulti, sftrRefPerTime, sftrResetFreqMulti, sftrResetFreqTime, spread);
    }
