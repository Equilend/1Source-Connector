...
public class PositionDTO {
    ...
    public int hashCode() {
        return Objects.hash(qualifiedName, accountGroup, accountGroupAccountNo2, accountGroupId, accountId, accountName,
            ...
            collateralIndex, collateralIndexName, collateralRate, collateralSpread, comments, competingBids,
            complianceTestMessage, counterpartyAccountNumber, counterpartyId, counterpartyName, country, countryId,
            couponPaymentSchedule, currencyId, currencyKy, customValue1, deliverFree, depoGroup, depoId, depoKy,
            dirtyPrice, divCurrency, divCurrencyId, divPerShare, divWithholdRate, doNotInstruct, doNotInstructCxlFail,
            doNotPost, doNotRecall, dtcNo, encumberedQuantity, endDate, errorMessage, evergreen, evergreenTerm,
            excludeFromAutoMark, explodedPosition, exposureId, extendableMaxDate, factor, futureSettleDate, index,
            indexName, instructions, interestAtMaturity, isBlock, isEvergreen, isExplodedPosition, isExtendable,
            isPooled, isThirdParty, lenderAccountId, lenderAccountName, matchGroup, matchGroupId, micId, nonMarkable,
            orderActionTs, poolPositionId, pooled, positionReferenceNumber, positionTradeId, positionType,
            positionTypeName, postDate, postTradeMarkPrice, prepaid, prepayBasis, prepayBasisName, prepayDate,
            prepayIndex, prepayIndexName, prepayRate, prepaySpread, price, priceFactor, productLine, quantity, rate,
            ...
            taxWithholdRate, terminationPrice, thirdParty, trackingInd, tradeCategoryId, tradeDate, tradeRefNo,
            tradingDesk, tradingDeskId, tranId, tripartyCustodianId, useDefaultCollateralAccount,
