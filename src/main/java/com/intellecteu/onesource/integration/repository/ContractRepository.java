...
public interface ContractRepository extends JpaRepository<Contract, Long> {
    ...
    @Query("select c from Contract c left join fetch c.lastEvent e left join fetch c.trade t left join fetch t.venue v left join fetch t.transactingParties prt left join fetch v.platform p where c.contractStatus = :status")
